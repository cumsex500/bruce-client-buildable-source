...
{
    public static wurstplusTessellator INSTANCE;
    ...
    public static void begin(final int mode) {
        wurstplusTessellator.INSTANCE.getBuffer().begin(mode, DefaultVertexFormats.POSITION_COLOR);
    }
    ...
    public static void render() {
        wurstplusTessellator.INSTANCE.draw();
    }
    ...
    public static void drawBox(final float x, final float y, final float z, final int argb, final int sides) {
        ...
        final int g = argb >>> 8 & 0xFF;
        final int b = argb & 0xFF;
        drawBox(wurstplusTessellator.INSTANCE.getBuffer(), x, y, z, 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    
    public static void drawBox(final BlockPos blockPos, final int r, final int g, final int b, final int a, final int sides) {
        drawBox(wurstplusTessellator.INSTANCE.getBuffer(), (float)blockPos.x, (float)blockPos.y, (float)blockPos.z, 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    
    public static BufferBuilder getBufferBuilder() {
        return wurstplusTessellator.INSTANCE.getBuffer();
    }
    ...
    public static void drawRange(final BlockPos blockPos, final float red, final float green, final float blue, final float alpha) {
        prepare(7);
        ...
        GL11.glColor4d((double)(red / 255.0f), (double)(green / 255.0f), (double)(blue / 255.0f), (double)(alpha / 255.0f));
        GL11.glBegin(9);
        final int r = 5;
        final int stacks = 20;
        final int sectors = 30;
        final double lengthInv = 1 / r;
        final double sectorStep = 6.283185307179586 / sectors;
        final double stackStep = 3.141592653589793 / stacks;
        for (int i = 0; i < stacks; ++i) {
            final double stackAngle = 1.5707963267948966 - i * stackStep;
            final double XY = r * Math.cos(stackAngle);
            final double Z = r * Math.sin(stackAngle);
            for (int j = 0; j < sectors; ++j) {
                final double sectorAngle = j * sectorStep;
                final double X = XY * Math.cos(sectorAngle);
                final double Y = XY * Math.sin(sectorAngle);
                GL11.glVertex3d(X + x, Y + y, Z + z);
                final double nX = X * lengthInv;
                final double nY = Y * lengthInv;
                final double nZ = Z * lengthInv;
                GL11.glNormal3d(nX + x, nY + y, nZ + z);
                final double s = j / sectors;
                final double t = i / stacks;
    ...
    static {
        wurstplusTessellator.INSTANCE = new wurstplusTessellator();
    }
}
