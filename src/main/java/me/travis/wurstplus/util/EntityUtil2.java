...
public class EntityUtil2
{
    ...
    public static boolean isPlayerMovingMomentum() {
        return EntityUtil2.mc.player.moveForward > 0.0f || EntityUtil2.mc.player.moveStrafing > 0.0f || EntityUtil2.mc.player.moveForward < 0.0f || EntityUtil2.mc.player.moveStrafing < 0.0f;
    }
    
    public static boolean isPlayerMovingLegit() {
        return EntityUtil2.mc.gameSettings.keyBindForward.isKeyDown();
    }
    
    public static void getPlayerSpeed() {
        final DecimalFormat df = new DecimalFormat("#.#");
        final double deltaX = EntityUtil2.mc.player.posX - EntityUtil2.mc.player.prevPosX;
        final double deltaY = EntityUtil2.mc.player.posY - EntityUtil2.mc.player.prevPosY;
    }
    
    public static int getPing() {
        if (EntityUtil2.mc.world == null || EntityUtil2.mc.player == null || EntityUtil2.mc.player.getUniqueID() == null) {
            return 0;
        }
        final NetworkPlayerInfo debugInfo = EntityUtil2.mc.getConnection().getPlayerInfo(EntityUtil2.mc.player.getUniqueID());
        if (debugInfo == null) {
            return 0;
        }
    ...
    static {
        EntityUtil2.mc = Minecraft.getMinecraft();
    }
}
