...
package me.travis.wurstplus.setting.config;
...
import me.travis.wurstplus.setting.converter.Convertable;
...
public class Configuration
{
    ...
    public static void loadConfiguration(final InputStream stream) {
        try {
            ...
            wurstplusMod.log.error("wurstplus Config malformed: resetting.");
