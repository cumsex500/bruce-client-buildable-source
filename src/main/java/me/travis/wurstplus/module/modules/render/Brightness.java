...
@Info(name = "Brightness", description = "Makes everything brighter!", category = Category.RENDER)
public class Brightness extends Module
{
    ...
    public Brightness() {
        ...
        this.seconds = this.register(Settings.floatBuilder("Seconds").withMinimum(0.0f).withMaximum(10.0f).withValue(1.0f).withVisibility(o -> this.transition.getValue()).build());
