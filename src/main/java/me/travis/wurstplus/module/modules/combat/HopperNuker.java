...
@Info(name = "HopperNuker", category = Category.COMBAT)
public class HopperNuker extends Module
{
    ...
    public HopperNuker() {
        this.range = this.register((Setting<Double>)Settings.doubleBuilder("Hit Range").withMinimum(1.0).withValue(4.0).withMaximum(6.0).build());
        this.pickswitch = this.register(Settings.b("Auto Switch", true));
        this.oldSlot = -1;
        this.isMining = false;
    }
