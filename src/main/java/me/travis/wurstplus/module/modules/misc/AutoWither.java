...
@Info(name = "Auto Wither", category = Category.MISC)
public class AutoWither extends Module
{
    ...
    public AutoWither() {
        this.useMode = this.register(Settings.e("UseMode", UseMode.SPAM));
        this.placeRange = this.register((Setting<Float>)Settings.floatBuilder("PlaceRange").withMinimum(2.0f).withValue(3.5f).withMaximum(10.0f).build());
